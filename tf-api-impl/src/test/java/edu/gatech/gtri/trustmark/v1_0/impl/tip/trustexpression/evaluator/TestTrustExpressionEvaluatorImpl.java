...
import edu.gatech.gtri.trustmark.v1_0.impl.tip.trustexpression.TrustExpressionEnvironment;
...
import static edu.gatech.gtri.trustmark.v1_0.impl.tip.trustexpression.TestTrustExpressionUtility.normalizeException;
import static edu.gatech.gtri.trustmark.v1_0.impl.tip.trustexpression.TestTrustExpressionUtility.resolver;
...
import static edu.gatech.gtri.trustmark.v1_0.tip.trustexpression.TrustExpressionFailure.failureTypeUnexpectedLeft;
        ...
        assertEquals(
                contains(
                        ...
                        terminal(success(dataValueString(
                                nel(trustInteroperabilityProfile2),
                                "string1"))),
                        fail(nel(failureTypeUnexpectedLeft(nel(trustInteroperabilityProfile2), TYPE_STRING_LIST, TYPE_DECIMAL)))),
