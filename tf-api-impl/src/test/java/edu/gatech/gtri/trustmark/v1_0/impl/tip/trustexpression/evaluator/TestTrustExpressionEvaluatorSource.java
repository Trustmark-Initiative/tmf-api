...
import edu.gatech.gtri.trustmark.v1_0.tip.trustexpression.evaluator.TrustExpressionEvaluatorSource.TrustExpressionEvaluatorSourceTrustmarkDefinitionParameter;
import edu.gatech.gtri.trustmark.v1_0.tip.trustexpression.evaluator.TrustExpressionEvaluatorSource.TrustExpressionEvaluatorSourceTrustmarkDefinitionRequirement;
import edu.gatech.gtri.trustmark.v1_0.tip.trustexpression.evaluator.TrustExpressionEvaluatorSource.TrustExpressionEvaluatorSourceValue;
...
public class TestTrustExpressionEvaluatorSource {
    ...
    public void testSourceTrustmarkDefinitionRequirement() {
        ...
        assertThrows(NullPointerException.class, () -> source(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, null));
        ...
        EqualsVerifier
                ...
                .withNonnullFields("trustInteroperabilityProfileNonEmptyList", "trustmarkDefinitionRequirement", "trustmarkList")
                .verify();
    }
