...
import edu.gatech.gtri.trustmark.v1_0.tip.TrustExpressionType.TrustExpressionTypeBoolean;
import edu.gatech.gtri.trustmark.v1_0.tip.evaluator.TrustExpressionEvaluatorData.TrustExpressionEvaluatorDataValueBoolean;
import edu.gatech.gtri.trustmark.v1_0.tip.evaluator.TrustExpressionEvaluatorData.TrustExpressionEvaluatorDataValueDateTimeStamp;
import edu.gatech.gtri.trustmark.v1_0.tip.evaluator.TrustExpressionEvaluatorData.TrustExpressionEvaluatorDataValueDecimal;
import edu.gatech.gtri.trustmark.v1_0.tip.evaluator.TrustExpressionEvaluatorData.TrustExpressionEvaluatorDataValueNone;
...
public class TestTrustExpressionEvaluatorData {
    ...
    public void testDataValueBoolean3() {
        ...
        assertThrows(NullPointerException.class, () -> dataValueBoolean(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, (List<Trustmark>) null));
        ...
        assertEquals(TrustExpressionTypeBoolean.TYPE_BOOLEAN, dataValueBoolean(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, trustmarkList).getTrustExpressionType());
    ...
    public void testDataValueBoolean5() {
        ...
        assertEquals(TrustExpressionTypeBoolean.TYPE_BOOLEAN, dataValueBoolean(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, trustmarkDefinitionParameter, trustmarkNonEmptyList, true).getTrustExpressionType());
    ...
    public void testDataValueDateTimeStamp5() {
        ...
        assertEquals(TYPE_DATE_TIME_STAMP, dataValueDateTimeStamp(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, trustmarkDefinitionParameter, trustmarkNonEmptyList, now).getTrustExpressionType());
    ...
    public void testDataValueDateTimeStamp2() {
        ...
        assertEquals(TYPE_DATE_TIME_STAMP, dataValueDateTimeStamp(trustInteroperabilityProfileNonEmptyList, now).getTrustExpressionType());
    ...
    public void testDataValueDecimal5() {
        ...
        assertEquals(TYPE_DECIMAL, dataValueDecimal(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, trustmarkDefinitionParameter, trustmarkNonEmptyList, BigDecimal.ONE).getTrustExpressionType());
    ...
    public void testDataValueDecimal2() {
        ...
        assertEquals(TYPE_DECIMAL, dataValueDecimal(trustInteroperabilityProfileNonEmptyList, BigDecimal.ONE).getTrustExpressionType());
    ...
    public void testDataValueString5() {
        ...
        assertEquals(TYPE_STRING, dataValueString(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, trustmarkDefinitionParameter, trustmarkNonEmptyList, "").getTrustExpressionType());
    ...
    public void testDataValueString2() {
        ...
        assertEquals(TYPE_STRING, dataValueString(trustInteroperabilityProfileNonEmptyList, "").getTrustExpressionType());
    ...
    public void testDataValueStringList() {
        ...
        assertEquals(TYPE_STRING_LIST, dataValueStringList(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, trustmarkDefinitionParameter, trustmarkNonEmptyList, arrayList("")).getTrustExpressionType());
    ...
    public void testDataValueNone() {
        ...
        assertEquals(TYPE_NONE, dataValueNone(trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, trustmarkDefinitionParameter, trustmarkNonEmptyList).getTrustExpressionType());
