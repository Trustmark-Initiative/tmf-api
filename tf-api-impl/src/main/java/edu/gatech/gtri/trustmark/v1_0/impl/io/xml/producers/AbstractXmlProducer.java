...
public abstract class AbstractXmlProducer implements XmlProducer {
    ...
    private static final Logger log = Logger.getLogger(AbstractXmlProducer.class);
    ...
    protected void writeString(XMLStreamWriter xmlWriter, String elementName, String value) throws XMLStreamException {
        xmlWriter.writeStartElement(NAMESPACE_URI, elementName);
        xmlWriter.writeCharacters(value);
        xmlWriter.writeEndElement();
    }

    protected void writeCDataString(XMLStreamWriter xmlWriter, String elementName, String value) throws XMLStreamException {
        xmlWriter.writeStartElement(NAMESPACE_URI, elementName);
    ...
    protected void writeXmlToStream(String xml, XMLStreamWriter writer) throws XMLStreamException {
    ...
    protected void writeMainIdentifyingInformation(XMLStreamWriter xmlWriter, TrustmarkFrameworkIdentifiedObject tfio) throws XMLStreamException {
    ...
    protected void writeLegalEase(XMLStreamWriter xmlWriter, LegallyPublished lp) throws XMLStreamException {
    ...
    protected void writeKeywords(XMLStreamWriter xmlWriter, Categorized categorized) throws XMLStreamException {
    ...
    protected void writeSatisfies(XMLStreamWriter xmlWriter, Supersedable supersedable) throws XMLStreamException {
    ...
    protected void writeKnownConflicts(XMLStreamWriter xmlWriter, Supersedable supersedable) throws XMLStreamException {
    ...
    protected void writeDeprecated(XMLStreamWriter xmlWriter, Supersedable supersedable) throws XMLStreamException {
    ...
    protected void writeSupersessionInfo(XMLStreamWriter xmlWriter, Supersedable supersedable) throws XMLStreamException {
