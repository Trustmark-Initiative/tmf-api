...
public class AgreementImpl implements Agreement {
    ...
    @Override
    public URI getIdentifier() { return this.identifier; }
    ...
    //// Agreement ////
    @Override
    public String getTitle() { return this.getName(); }
    public void setTitle(String title) { this.setName(title); }
    ...
    @Override
    public Date getEffectiveDateTime() { return this.effectiveDateTime; }
    public void setEffectiveDateTime(Date effectiveDateTime) { this.effectiveDateTime = effectiveDateTime; }
    
    @Override
    public Date getTerminationDateTime() { return this.terminationDateTime; }
    public void setTerminationDateTime(Date terminationDateTime) { this.terminationDateTime = terminationDateTime; }
    
    @Override
    public List<AgreementNonBindingSection> getNonBindingSections() {
        if (this.nonBindingSections == null) { this.nonBindingSections = new ArrayList<>(); }
    ...
    public SortedSet<Term> getTerms() {
        if (this.terms == null) { this.terms = new TreeSet<>(); }
        return this.terms;
    }
    ...
    public SortedSet<AgreementParty> getParties() {
        if (this.parties == null) { this.parties = new TreeSet<>(); }
        return this.parties;
    }
    ...
    @Override
    public String getSignaturePageText() { return this.signaturePageText; }
    public void setSignaturePageText(String signaturePageText) { this.signaturePageText = signaturePageText; }
