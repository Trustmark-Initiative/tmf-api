...
import static edu.gatech.gtri.trustmark.v1_0.tip.trustexpression.evaluator.TrustmarkDefinitionRequirementEvaluation.trustmarkDefinitionRequirementEvaluation;
    ...
    private static Validation<NonEmptyList<TrustExpressionFailure>, List<TrustmarkDefinitionRequirement>> evaluateTrustExpression(
        ...
        return data.match(
                ...
                dataReference -> dataReference.matchReference(
                        (trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement) -> success(arrayList(trustmarkDefinitionRequirement)),
                        (trustInteroperabilityProfileNonEmptyList, trustmarkDefinitionRequirement, trustmarkDefinitionParameter) -> success(arrayList(trustmarkDefinitionRequirement))),
