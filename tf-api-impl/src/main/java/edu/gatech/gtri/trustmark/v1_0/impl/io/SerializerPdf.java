...
public class SerializerPdf extends AbstractSerializer {
    ...
    ////// Constants //////
    public static final String NAME = "PDF Serializer";
    public static final String DESCRIPTION = "Serializes data into PDF.";
    public static final String OUTPUT_MIME_FORMAT = "application/pdf";
    ...
    public void serialize(Agreement agreement, OutputStream outputStream, Map model) throws IOException {
        this.transformXmlToPdf(agreement, outputStream, model, new XmlPreparer<Agreement>() {
            @Override public String getXslFoTemplateName() {
