...
/**
 * A value expression based on BDDs created specifically for trust
 * interoperability profile evaluation.
 * <p>
 * The implementation of this class uses the JDD BDD library and is also based
 * on {@link TreeValueExpression} from the Java Unified Expression Library
 * (JUEL).
 * <p>
 * Instances of this class are usually created using an
 * {@link ELExpressionFactoryJDD}.
 *
 * @author GTRI Trustmark Team
 */
@SuppressWarnings("serial")
public class BDDValueExpression extends javax.el.ValueExpression {
     ...
     */
    public BDDValueExpression(TreeStore store, FunctionMapper functions,
                              VariableMapper variables, TypeConverter converter, String expr,
                              Class<?> type) {
        super();
     ...
     * expressions
     * @throws ELException if evaluation fails (e.g. property not found, type conversion
     *                     failed, ...)
     */
    @Override
    ...
    public boolean equals(Object obj) {/*
		if (obj != null && obj.getClass() == getClass()) {
			...
			return getStructuralId().equals(other.getStructuralId())
