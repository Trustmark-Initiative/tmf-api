...
/**
 * This implementation of the {@link TrustExpressionAdapter} will simply provide a true/false whether the trust expression
 * is lexically valid or not.  It does NOT try to evaluate it.
 * <br/><br/>
 * @author brad
 * @date 3/6/17
 */
public class TrustExpressionValidator extends TrustExpressionAdapter {
    //==================================================================================================================
    //  STATIC VARIABLES
    //==================================================================================================================
    ...
    //  CONSTRUCTORS
    //==================================================================================================================
    public TrustExpressionValidator(String trustExpression, List<Map> trustmarkBindingData){
