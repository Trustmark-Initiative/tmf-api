...
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeDistinct;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeElementNonNull;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeEmpty;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeEqual;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeLengthGreaterThanOrEqual;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeLengthLessThanOrEqual;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeNonNull;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeNumeric;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBePattern;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeReference;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustBeUnique;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageMustHavePermission;
import static edu.gatech.gtri.trustmark.v1_0.web.validation.ValidationMessage.validationMessageNonEmptyList;
...
public final class ValidationUtility {
    ...
    public static <FIELD, V1, V2> Validation<NonEmptyList<ValidationMessage<FIELD>>, V2> mustBeNullOr(
            final FIELD field,
            final V1 value,
            final F2<FIELD, V1, Validation<NonEmptyList<ValidationMessage<FIELD>>, V2>> validation) {
    ...
    public static <FIELD, V1, V2> Validation<NonEmptyList<ValidationMessage<FIELD>>, Option<V2>> mustBeNoneOr(
            final FIELD field,
            final Option<V1> option,
            final F2<FIELD, V1, Validation<NonEmptyList<ValidationMessage<FIELD>>, V2>> validation) {
        ...
        return option
                .map(value -> validation.f(field, value).map(Option::some))
                .orSome(success(none()));
    }

    public static <REQUESTER, AUTHORITY, FIELD, RESPONSE> Validation<NonEmptyList<ValidationMessage<FIELD>>, RESPONSE> requesterMay(
            final REQUESTER requester,
            final F1<REQUESTER, Collection<AUTHORITY>> getPermissionCollection,
            final AUTHORITY permission,
            final F1<REQUESTER, Validation<NonEmptyList<ValidationMessage<FIELD>>, RESPONSE>> f) {

        return getPermissionCollection.f(requester).contains(permission) ?
                f.f(requester) :
                fail(nel(validationMessageMustHavePermission(null)));
    }
}
