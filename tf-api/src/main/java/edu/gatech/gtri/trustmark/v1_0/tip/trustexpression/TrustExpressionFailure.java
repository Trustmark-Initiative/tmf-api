...
public abstract class TrustExpressionFailure {
    ...
    public abstract <T1> T1 match(
            ...
            F3<NonEmptyList<TrustInteroperabilityProfile>, TrustExpressionType, TrustExpressionType, T1> fTrustExpressionFailureTypeUnexpected,
            F3<NonEmptyList<TrustInteroperabilityProfile>, TrustExpressionType, TrustExpressionType, T1> fTrustExpressionFailureTypeUnexpectedLeft,
            F3<NonEmptyList<TrustInteroperabilityProfile>, TrustExpressionType, TrustExpressionType, T1> fTrustExpressionFailureTypeUnexpectedRight,
    ...
    public static final class TrustExpressionFailureTypeUnexpected extends TrustExpressionFailure {
        private final NonEmptyList<TrustInteroperabilityProfile> trustInteroperabilityProfileNonEmptyList;
        private final TrustExpressionType typeExpected;
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionFailureTypeUnexpected.f(trustInteroperabilityProfileNonEmptyList, typeExpected, typeActual);
        }
        ...
        public boolean equals(final Object o) {
            ...
            return trustInteroperabilityProfileNonEmptyList.equals(that.trustInteroperabilityProfileNonEmptyList) && typeExpected == that.typeExpected && typeActual == that.typeActual;
        }

        @Override
        public int hashCode() {
            return Objects.hash(trustInteroperabilityProfileNonEmptyList, typeExpected, typeActual);
        }
    }
    ...
    public static final class TrustExpressionFailureTypeUnexpectedLeft extends TrustExpressionFailure {
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionFailureTypeUnexpectedLeft.f(trustInteroperabilityProfileNonEmptyList, typeExpected, typeActual);
        }
    ...
    public static final class TrustExpressionFailureTypeUnexpectedRight extends TrustExpressionFailure {
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionFailureTypeUnexpectedRight.f(trustInteroperabilityProfileNonEmptyList, typeExpected, typeActual);
        }
    ...
    public static final TrustExpressionFailure failureTypeUnexpected(
        ...
        return new TrustExpressionFailureTypeUnexpected(trustInteroperabilityProfileNonEmptyList, typeExpected, typeActual);
    }
    ...
    public static final TrustExpressionFailure failureTypeUnexpectedLeft(
        ...
        return new TrustExpressionFailureTypeUnexpectedLeft(trustInteroperabilityProfileNonEmptyList, typeExpected, typeActual);
    }
    ...
    public static final TrustExpressionFailure failureTypeUnexpectedRight(
        ...
        return new TrustExpressionFailureTypeUnexpectedRight(trustInteroperabilityProfileNonEmptyList, typeExpected, typeActual);
    }
