...
public abstract class TrustExpressionEvaluatorData {
    ...
    public abstract TrustExpressionType getType();
    ...
    public static final class TrustExpressionEvaluatorDataValueBoolean extends TrustExpressionEvaluatorData {
        ...
        public TrustExpressionType getType() {
            return TYPE_BOOLEAN;
        }
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionEvaluatorDataValueBoolean.f(getSource(), getType(), getValue());
        }
    ...
    public static final class TrustExpressionEvaluatorDataValueDateTimeStamp extends TrustExpressionEvaluatorData {
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionEvaluatorDataValueDateTimeStamp.f(getSource(), getType(), getValue());
        }
    ...
    public static final class TrustExpressionEvaluatorDataValueDecimal extends TrustExpressionEvaluatorData {
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionEvaluatorDataValueDecimal.f(getSource(), getType(), getValue());
        }
    ...
    public static final class TrustExpressionEvaluatorDataValueString extends TrustExpressionEvaluatorData {
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionEvaluatorDataValueString.f(getSource(), getType(), getValue());
        }
    ...
    public static final class TrustExpressionEvaluatorDataValueStringList extends TrustExpressionEvaluatorData {
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionEvaluatorDataValueStringList.f(getSource(), getType(), getValue());
        }
    ...
    public static final class TrustExpressionEvaluatorDataValueNone extends TrustExpressionEvaluatorData {
        ...
        public <T1> T1 match(
            ...
            return fTrustExpressionEvaluatorDataValueNone.f(getSource(), getType());
        }
